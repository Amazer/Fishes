...
public class ExcelEditorWindow : EditorWindow
{
    ...
    void DrawTableDatas()
    {
        ...
        for (int i = 0; i < Table_FishItemTool.instance.dataArray.Length; i++)
        {
            EditorGUILayout.BeginHorizontal();
            ...
            {
                EditorGUILayout.LabelField(itemFieldInfoArray[j].GetValue(Table_FishItemTool.instance.dataArray[i]).ToString(), GUILayout.Width(100));
            }
            EditorGUILayout.EndHorizontal();
        }
    ...
    void LoadExcelData()
    {
        itemFieldInfoArray = typeof(Table_FishItem).GetFields();
    }
    ...
    void GetSelectDataStringValues()
    {
        ...
        for (int i = 0; i < itemFieldInfoArray.Length; i++)
        {
            var value = itemFieldInfoArray[i].GetValue(Table_FishItemTool.instance.dataArray[selectedIndex]);
            if (value != null)
            {
    ...
    public void WriteToExcel()
    {
        ...
        string path = TableConfig.excelsFolderPath + "FishItem.xlsx";
    ...
    void SaveToAsset()
    {
        Table_FishItemTool.instance.dataArray[selectedIndex] = GetNewItem();
        AssetDatabase.SaveAssets();
        AssetDatabase.Refresh();
        Debug.Log("SaveToAsset Success");
    }

    Table_FishItem GetNewItem()
    {
